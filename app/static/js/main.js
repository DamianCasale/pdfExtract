...
var theDropzone = new Dropzone("#theDropzone", {
    url: "/upload",
    previewsContainer: "#previews",
    clickable: "#clickable",
    acceptedFiles: "application/pdf,.psd",
    dictInvalidFileType: "PDF Files Only",
    /*dictDefaultMessage: ''*/
  })
  .on("addedfile", function(file) {
    if (!file.type.match(/image.*/)) {
      ...
      theDropzone.emit("thumbnail", file, "http://www.onlinesupport.co.uk/wp-content/uploads/2015/01/ACP_PDF-2_file_document.png");
	}
  });
